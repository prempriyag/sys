...
router = APIRouter(
    prefix="/api/school/transcriptreports",
...
async def ajaxlist(
    ...
    Matches CI3 Transcriptreports::ajaxlist() -> SchoolTranscripts_model::getreportsdata()
    """
    try:
        ...
        result = SchoolTranscriptReportsModel.get_reports_data(
            db=db,
