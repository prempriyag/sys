            ...
            for col in columns:
                ...
                if col_search_value:
                    ...
                    if col_data == "INSTITUTION_ID":
                        search_conditions.append(f"a.INSTITUTION_ID like '%{col_search_safe}%'")
                    elif col_data == "INSTITUTION_NAME":
                        search_conditions.append(f"lower(m.INSTITUTION_NAME) like '%{col_search_lower}%'")
                    elif col_data == "EFFECTIVE_START_TERM":
                        search_conditions.append(f"lower(a.EFFECTIVE_START_TERM) like '%{col_search_lower}%'")
                    elif col_data == "EFFECTIVE_END_TERM":
                        search_conditions.append(f"lower(a.EFFECTIVE_END_TERM) like '%{col_search_lower}%'")
                    elif col_data == "UPDATED_BY":
                        search_conditions.append(f"lower(a.UPDATED_BY) like '%{col_search_lower}%'")
                    elif col_data == "UPDATED_ON":
                        search_conditions.append(f"a.UPDATED_ON like '%{col_search_safe}%'")
