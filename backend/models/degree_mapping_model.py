        ...
        if columns:
            for col in columns:
                ...
                if col_search_value:
                    ...
                    if col_data == "DEGREE_CD":
                        search_conditions.append(f"DEGREE_CD like '%{col_search_safe}%'")
                    elif col_data == "DEGREE_NAME":
                        search_conditions.append(f"lower(DEGREE_NAME) like '%{col_search_lower}%'")
