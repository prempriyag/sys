...
class SchoolTranscriptsModel:
    ...
    def get_transcripts_data(
        ...
        try:
            ...
            search_query = SchoolTranscriptsModel.build_search_conditions(request_data)

            # Build ORDER BY clause
            order_by_column = SchoolTranscriptsModel.get_order_by_column(column_name)
            ...
            where_clauses.append(f"d.PROJECT_ID = {SCHOOL_PROJECT_ID}")
