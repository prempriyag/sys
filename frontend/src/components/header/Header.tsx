...
const Header: React.FC<HeaderProps> = ({ onClick, onToggle }) => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-brand-200/50 z-99999 dark:border-gray-700/80 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-brand-200/50 dark:border-gray-700/80 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
          ...
          <button
            onClick={onClick}
            className="items-center justify-center hidden w-10 h-10 text-gray-500 border-brand-200/50 rounded-lg z-99999 dark:border-gray-700/80 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          >
            <svg
