...
export default function ArticulationBotLog() {
  ...
  return (
    <PageWrapper>
      <PageMeta
        title="Articulation Log | College Module"
        description="Articulation Bot Log"
      />
      <PageBreadcrumb pageTitle="Articulation Log" />
      ...
      <PageContainer>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div>
                ...
                >
                  ...
                  <option value="STATUS_BANNER_ARTICULATION">Status Banner Articulation</option>
                  <option value="STUDENT_ID">Student ID</option>
                  <option value="SUBJECT">Subject</option>
                  <option value="TERM">Term</option>
                  <option value="ARTICULATION_STATUS_FLAG">Articulation Status</option>
                  <option value="ARCH_CREDITS_YN">ARCH Credits</option>
                  <option value="ARCH_CREDITS_ACTION">ARCH Credits Action</option>
        ...
        <DataTable
          ...
          ajaxUrl={API_ENDPOINTS.ARTICULATION_BOT_LOG_LIST}
          ajaxData={ajaxData}
          columns={[
            ...
            { data: "BOT_AUDIT_SEQ", name: "Bot Audit Seq", searchable: false, orderable: false },
            { 
              data: "STUDENT_ID", 
              name: "Student ID", 
              searchable: true, 
