...
export default function CollegeHeaderData() {
  ...
  const hasUpdatePermission = hasPermission("college_header_data", "update");
  ...
  return (
    <PageWrapper>
      <PageMeta
        title="College Header Data | OCR"
        description="College transcript header data for OCR verify"
      />
      <PageBreadcrumb pageTitle="College Header Data" />
      ...
      <PageContainer>
        ...
        <DataTable
          ...
          ajaxUrl={API_ENDPOINTS.OCR_COLLEGE_HDR_AJAXLIST}
          ajaxData={ajaxData}
          columns={[
            {
              data: "BATCH_ID",
              ...
              render: (data: string) => {
                ...
                return (
                  <span className="inline-flex items-center whitespace-nowrap">
                    ...
                    <Link
                      to={`/ocrverify/collegehdrbatch?batch_id=${encodeURIComponent(data)}&verify=no`}
