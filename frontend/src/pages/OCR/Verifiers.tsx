...
import ResetPasswordModal from "../College/users/ResetPasswordModal";
import AddUserModal from "../College/users/AddUserModal";
import EditUserModal from "../College/users/EditUserModal";
...
export default function Verifiers() {
  ...
  return (
    <PageWrapper>
      <PageMeta
        title="Verifiers | OCR Verify"
        description="Manage OCR verifier users"
      />
      ...
      <PageContainer>
        ...
        {/* Verifiers DataTable - same as User Management but filtered by type=verifiers */}
        <DataTable
          ...
          ajaxUrl={`${API_BASE_URL}${API_ENDPOINTS.USERS_LIST}?type=verifiers`}
          ajaxMethod="POST"
          pageLength={10}
