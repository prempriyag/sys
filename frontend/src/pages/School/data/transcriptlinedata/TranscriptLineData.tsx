...
export default function TranscriptLineData() {
  ...
  const hasUpdatePermission = hasPermission("college_transcript_line_data", "UPDATE");
  ...
  return (
    <PageWrapper>
      <PageMeta
        title="Transcript Line DATA | College Module"
        description="Transcript Line DATA"
      />
      <PageBreadcrumb pageTitle="Transcript Line DATA" />
      ...
      <PageContainer>
        ...
        <DataTable
          ...
          ajaxUrl={API_ENDPOINTS.TRANSCRIPT_LINE_DATA_LIST}
          ajaxData={ajaxData}
          columns={[
            { 
              data: "BATCH_ID", 
            ...
            { data: "START_TERM_NAME", name: "Start Term Name", searchable: true, orderable: true },
            { data: "END_TERM_NAME", name: "End Term Name", searchable: true, orderable: true },
            { data: "START_TERM_YEAR", name: "Start Term Year", searchable: true, orderable: true },
            { data: "END_TERM_YEAR", name: "End Term Year", searchable: true, orderable: true },
